...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.getUrl = function (arquivo) {
        ...
        return this.http.get(arquivo)
            ...
            if (localStorage.getItem('client_id')) {
                var parts = url.split('client_id=');
                var number = parts[1].split('&');
    ...
    AuthenticationService.prototype.getClientCode = function (client) {
        var location = window.location.href.split(':');
        return this.http.get(location[0] + ':' + location[1] + ':' + default_headers_1.DefaultHeaders.port + '/auth/client?filter={"name":"' + client + '"}')
